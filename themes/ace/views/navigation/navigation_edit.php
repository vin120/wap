                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                            	<input type='hidden' name='old_name' value="<?php echo $navigation['navigation_name']?>"/>
                            	<input type='hidden' name='act_id' value="<?php echo $navigation['activity_id']?>"/>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '导航名')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '导航名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="10" value="<?php echo $navigation['navigation_name']?>"/>
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<!-- <select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="activity">
                                            ...
                                            <option value="<?php echo $row['activity_id']?>" <?php if($navigation['activity_id']==$row['activity_id']){echo "selected='selected'";}?>><?php  echo $row['activity_name']?></option>
                                            <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="sort" placeholder="<?php echo yii::t('vcos', '排序')?>" class="col-xs-10 col-sm-8 col-md-8" name="sort" maxlength="10" value="<?php echo $navigation['sort_order']?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($navigation['is_show']){echo "checked='checked'";}?> class="ace ace-switch ace-switch-5" name="show" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($navigation['is_main']){echo "checked='checked'";}?>  class="ace ace-switch ace-switch-5" name="main" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($navigation['is_category']==1){echo "checked='checked'";}?> class="ace ace-switch ace-switch-5" name="set_cat" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group type_check_tr <?php if($navigation['is_category']==1){echo 'hidden';}?>">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7 type_check">
                                    	<?php $type_arr = explode(',', $navigation['navigation_style_type']);?>
                                    	<label style="margin:1px 15px 0px 0px;"><input <?php echo in_array('1', $type_arr)?"checked='checked'":'';?> style="margin-right: 5px;" type="checkbox" name="type_activity" value="1"/>活动</label>
                                    	<label style="margin:1px 15px 0px 0px;"><input <?php echo in_array('2', $type_arr)?"checked='checked'":'';?> style="margin-right: 5px;" type="checkbox" name="type_shop" value="2"/>店铺</label>
                                    	<label style="margin:1px 15px 0px 0px;"><input <?php echo in_array('3', $type_arr)?"checked='checked'":'';?> style="margin-right: 5px;" type="checkbox" name="type_product" value="3"/>商品</label>
                                        <?php echo $form->error($navigation,'navigation_style_type'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($navigation['status']==1){echo "checked='checked'";}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
...
jQuery(function($){
    ...
    $("input[name='main']").click(function(){
    	...
    	if(this_checked == 1){
        	...
        	$.ajax({
        		type:'get',
    			async: false, 
    			data:'nav_id='+<?php echo $navigation['navigation_id']?>,
    ...
    $('form').submit(function(){
       ...
       //判断导航名是否已经存在
        var id  = <?php echo $navigation['navigation_id'];?>;
