<?php
    $this->pageTitle = Yii::t('vcos','导航内容列表');
    $theme_url = Yii::app()->theme->baseUrl;
    $menu_type = 'navigation_content';
?>
<?php 
    //navbar 挂件
                                            ...
                                            <div class="table-responsive">
                                            	...
                                            	<div class="list_select_option">
                                             	  ...
                                             	  foreach($navigation_sel as $row){
                                             	  	$path_url = Yii::app()->createUrl('Navigation/navigation_content',array('type'=> $type_but,'naviagtion'=> $row['navigation_id']));
                                             	  ?>
                                             	  	<option value="<?php echo $path_url;?>" <?php if($row['navigation_id'] == $navigation_but){echo 'selected';}?>><?php echo $row['navigation_name']?></option>
                                             	  <?php }?>
                                             	  </select>
                                             	  <label><?php echo yii::t('vcos', '请选择活动类型')?>:</label>
                                             	  <select class='city_sel' name='type_all_sel'>
                                             	  <?php $path_url_all = Yii::app()->createUrl('Navigation/navigation_content',array('naviagtion'=> $navigation_but,'type'=>'0'));?>
                                             	  	<option value="<?php echo $path_url_all;?>" <?php if($type_but == 0){echo "selected='selected'";}?>><?php echo yii::t('vcos', '全部')?></option>
                                             	  <?php $path_url_shop = Yii::app()->createUrl('Navigation/navigation_content',array('naviagtion'=> $navigation_but,'type'=>'3'));?>
                                             	  	<option value="<?php echo $path_url_shop;?>" <?php if($type_but == 3){echo "selected='selected'";}?>><?php echo yii::t('vcos', '店铺')?></option>
                                             	  <?php $path_url_activity = Yii::app()->createUrl('Navigation/navigation_content',array('naviagtion'=> $navigation_but,'type'=>'4'));?>
                                             	  	<option value="<?php echo $path_url_activity;?>" <?php if($type_but == 4){echo "selected='selected'";}?>><?php echo yii::t('vcos', '活动')?></option>
                                             	  <?php $path_url_product = Yii::app()->createUrl('Navigation/navigation_content',array('naviagtion'=> $navigation_but,'type'=>'6'));?>
                                             	  	<option value="<?php echo $path_url_product;?>" <?php if($type_but == 6){echo "selected='selected'";}?>><?php echo yii::t('vcos', '商品')?></option>
                                             	  </select>
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '店铺/活动/商品名')?></th>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($activity_product as $key=>$row) { ?>
                                                        <tr>
                                                            <td class="center">
                                                                <label>
                                                            ...
                                                            <td><?php echo ++$key;?></td>
                                                            <td><?php echo $navigation_sel[0]['activity_name'];?></td>
                                                            <td><?php if($row['product_type']==3){echo "店铺";}elseif($row['product_type']==6){echo "商品";}elseif($row['product_type']==4){echo "活动";}?></td>
                                                            <td><?php echo $row['title'];?></td>
                                                            <td><?php echo $row['sort_order'];?></td>
                                                            <td><?php echo $row['start_show_time'];?></td>
                                                            <td><?php echo $row['end_show_time'];?></td>
                                                            <td>
                                                                <?php
                                                                    $this->widget('ManipulateWidget',array(
                                                                        'ControllerName'=>'Activity',
                                                                        'MethodName'=>'activity_product_edit',
                                                                        'id'=>$row['id'],
                                                                        'canedit'=>$canedit,
                                                                        'candelete'=>$candelete,
                                                                    ));
                                                ...
                                                <div class="center">
                                                    <?php
                                                        ...
                                                        $this->widget('BotWidget',array(
                                                            'ControllerName'=>'Activity',
                                                            'MethodName'=>'activity_product_add',
                                                            'canadd'=>$canadd,
                                                            'candelete'=>$candelete,
                                                        ));
                                                    ?>
...
<script type="text/javascript">
    jQuery(function($) {
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            location.href="<?php echo Yii::app()->createUrl("Navigation/navigation_content");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
                    ,
		...
		/*
        $(".list_select_option select[name='activity_all_sel']").change(function(){
        	var path = $(this).val();
    		window.location.href=path;
    	});
        
        $(".list_select_option select[name='type_all_sel']").change(function(){
        	var path = $(this).val();
    		window.location.href=path;
    	});*/
    });
