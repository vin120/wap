<?php
    $this->pageTitle = Yii::t('vcos','添加航线');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '航线名')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="vtime" placeholder="<?php echo yii::t('vcos', '航行时间')?>" class="col-xs-10 col-sm-8 col-md-8" name="vtime" maxlength="80" />
