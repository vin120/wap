                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="old_price" placeholder="<?php echo yii::t('vcos', '原价')?>" class="col-xs-10 col-sm-8 col-md-8" name="old_price" maxlength="10" value="<?php echo $ls['old_price']/100;?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="id-date-picker-3" type="text" maxlength='15'  placeholder="<?php echo yii::t('vcos', '电话')?>" name="tel" value="<?php echo $ls['ls_tel'];?>"/>
