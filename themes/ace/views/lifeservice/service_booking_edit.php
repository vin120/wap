                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="edit" >
                                <div class="form-group">
                                    ...
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $detail['booking_no'];?></label>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '类型').' : ';?></label>
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $detail['booking_type']==1?"餐厅":"休闲服务";?></label>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php if($detail['booking_type']==1){echo yii::t('vcos', '餐厅').' : ';}else{echo yii::t('vcos', '休闲服务').' : ';}?></label>
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $store['store_name'];?></label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $detail['booking_name'];?></label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-6 col-sm-6 col-md-6" name="state">
                                            ...
                                            <option value="0" <?php if($detail['status'] == '0'){echo 'selected';}?> class="state"><?php echo yii::t('vcos', '已取消')?></option>
                                            <?php }else{?>
                                            <option value="1" <?php if($detail['status'] == '1'){echo 'selected';}?> class="state"><?php echo yii::t('vcos', '处理中')?></option>
                                            <option value="2" <?php if($detail['status'] == '2'){echo 'selected';}?> class="state"><?php echo yii::t('vcos', '预定成功')?></option>
                                            <option value="3" <?php if($detail['status'] == '3'){echo 'selected';}?> class="state"><?php echo yii::t('vcos', '预定失败，人数已满')?></option>
                                            <option value="4" <?php if($detail['status'] == '4'){echo 'selected';}?> class="state"><?php echo yii::t('vcos', '完成服务')?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
