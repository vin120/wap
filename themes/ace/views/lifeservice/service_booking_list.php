                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <label style="margin-top:-8px;">选择类型:</label>
                                            	<select name="booking_type_sel" style="width:120px;position: relative;bottom:5px;">
                                            		<option <?php if($type==0){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Lifeservice/service_booking_list",array('type'=>0))?>">全部</option>
                                            		<option <?php if($type==1){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Lifeservice/service_booking_list",array('type'=>1))?>">餐厅</option>
                                            		<option <?php if($type==2){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Lifeservice/service_booking_list",array('type'=>2))?>">休闲服务</option>
                                            	</select>
                                                <form method="post" >
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '餐厅/休闲服务')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['booking_type']==1?"餐厅":"休闲服务";?></td>
                                                            <td><?php echo $row['store_name']['store_name'];?></td>
                                                            ...
                                                            <td>
                                                                <select class="col-xs-10 col-sm-8 col-md-8 state" name="state" id="<?php echo $row['id']?>" title="<?php echo $row['status'];?>">
                                                                    <?php if($row['status'] == '0'){?>
                                                                    <option value="0" <?php if($row['status'] == '0'){echo 'selected';}?> ><?php echo yii::t('vcos', '已取消')?></option>
                                                                    <?php }else{?>
                                                                    <option value="1" <?php if($row['status'] == '1'){echo 'selected';}?> ><?php echo yii::t('vcos', '处理中')?></option>
                                                                    <option value="2" <?php if($row['status'] == '2'){echo 'selected';}?> ><?php echo yii::t('vcos', '预定成功')?></option>
                                                                    <option value="3" <?php if($row['status'] == '3'){echo 'selected';}?> ><?php echo yii::t('vcos', '预定失败，人数已满')?></option>
                                                                    <option value="4" <?php if($row['status'] == '4'){echo 'selected';}?> ><?php echo yii::t('vcos', '完成服务')?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </td>
                                                            <td>
...
<script type="text/javascript">
jQuery(function($) {
	$("select[name='booking_type_sel']").change(function(){
		var path = $(this).val();
