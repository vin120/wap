<?php
    $this->pageTitle = Yii::t('vcos','休闲服务管理');
...
<?php 
    ...
    if(in_array('61', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('62', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('63', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="list_select_option">
                                            	  <label><?php echo yii::t('vcos', '请选择服务分类')?>:</label>
                                             	  <select class='lifeservice_sel' name='category_all_sel'>
                                             	  <?php
                                             	   $path_url_first = Yii::app()->createUrl('Lifeservice/service_list',array('category'=> 0));
                                             	  ?>
                                             	  ...
                                             	  <?php foreach($category_sel as $row){
                                             	  	$path_url = Yii::app()->createUrl('Lifeservice/service_list',array('category'=> $row['lc_id']));
                                             	  ?>
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '营业时间')?></th>
                                                            <th><?php echo yii::t('vcos', '状态')?></th>
                                                            <th><?php echo yii::t('vcos', '地址')?></th>
                                                            <th><?php echo yii::t('vcos', '电话')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="center">
                                                                <label>
                                                                    <input type="checkbox" name="ids[]" value="<?php echo $row['ls_id'];?>" class="ace isclick" />
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </td>
                                                            <td><?php echo ++$key?></td>
                                                            <td><?php echo $row['ls_title'];?></td>
                                                            <td><?php echo sprintf('%.2f',$row['ls_price']/100);?></td>
                                                            <td><?php echo $row['ls_opening_time'];?></td>
                                                            <td><?php echo $row['ls_state']?yii::t('vcos', '启用'): yii::t('vcos', '禁用');?></td>
                                                            <td><?php echo $row['ls_address'];?></td>
                                                            <td><?php echo $row['ls_tel'];?></td>
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Lifeservice/Service_list");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
