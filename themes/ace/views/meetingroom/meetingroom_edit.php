<?php
    $this->pageTitle = Yii::t('vcos','编辑会议设施介绍');
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'meetingroom_add';
    $menu_type = 'meetingroom_list';
?>
<?php 
    //navbar 挂件
    $disable = 1;
            ...
            <div class="main-content"> 
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            <?php echo yii::t('vcos', '会议设施管理')?>
                            <small style="cursor:pointer">
                                    <i class="icon-double-angle-right"></i>
                                    <a href="<?php echo Yii::app()->createUrl("Meetingroom/meetingroom_list")?>"><?php echo yii::t('vcos', '会议设施介绍列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑会议设施介绍')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($detail['state']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo Yii::app()->params['imgurl'].$detail['img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                        <input type="file" name="photo" id="photo"/>
                                    </div>
                                    <?php echo $form->error($detail,'img_url'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
...
jQuery(function($){
    ...
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
	        ...
	        $.post("<?php echo Yii::app()->createUrl("meetingroom/getiso")?>",{iso:$a,id:$b},function(data){
	            if(data != 0){
