<?php
    $this->pageTitle = Yii::t('vcos','新增目的地介绍');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($detail,'port_id'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '港口图片')?>：</label>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <input type="file" name="photo" id="photo"/>
                                    </div>
                                    <?php echo $form->error($detail,'detail_img_url'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($detail_language,'detail'); ?> 
                                </div>
                                <div class="space-4"></div>
...
jQuery(function($){
    ...
    $("#add").validate({
        ...
        messages:{
            photo:"<?php echo yii::t('vcos', '请上传客房图片')?>",
        }
    });
