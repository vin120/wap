<?php
    $this->pageTitle = Yii::t('vcos','编辑邮轮介绍');
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'cruiseinfo_add';
    $menu_type = 'cruiseinfo_list';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Cruiseinfo/cruiseinfo_list")?>"><?php echo yii::t('vcos', '邮轮介绍列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑邮轮介绍')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo Yii::app()->params['imgurl'].$detail['cruise_img'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <?php 
                                    $msg = $detail_language['cruise_info'];
...
jQuery(function($){
    ...
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
            ...
            $.post("<?php echo Yii::app()->createUrl("cruiseinfo/getiso_cruiseinfo")?>",{iso:$a,id:$b},function(data){
                if(data != 0){
                    var result = jQuery.parseJSON(data);
                    $(".iso textarea").html('');
                    var msg = result['cruise_info'];
