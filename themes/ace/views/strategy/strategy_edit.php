                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Strategy/strategy_list")?>"><?php echo yii::t('vcos', '攻略管理')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="phone" type="text" maxlength="15" name="phone"  value="<?php echo $strategy_language['telphone']?>" placeholder="<?php echo yii::t('vcos', '电话号码')?>" />
...
jQuery(function($){
	...
	<?php if($strategy_language['iso'] == 'zh_cn'){?>
    $("#edit").validate({
        rules: {
    ...
    $("#edit").validate({
        rules: {
            ...
            address:{required:true,isEnglish:true},
            type:{required:true,isEnglish:true},
            feature:{required:true,isEnglish:true},
            price:{required:true, isFloatGtZero:true},
            country:{required:true, digits:true},
            city:{required:true, digits:true},
            category:{required:true, digits:true},
    ...
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
	        ...
	        $("input[name='name']").removeClass("stringCheckAll");
	       // $("textarea[name='desc']").removeClass("stringCheckAll");
	        $("input[name='address']").removeClass("stringCheckAll");
	        $("input[name='type']").removeClass("stringCheckAll");
	        $("input[name='feature']").removeClass("stringCheckAll");
	        $("input[name='name']").addClass("isEnglish");
	        $("textarea[name='desc']").addClass("isEnglish");
	        $("input[name='address']").addClass("isEnglish");
	        $("input[name='type']").addClass("isEnglish");
	        $("input[name='feature']").addClass("isEnglish");
        }else if($check == 'yes'){
        	$(this).attr('check','no');
        	$(this).val('zh_cn');
	        ...
	        $("input[name='name']").removeClass("isEnglish");
	        $("textarea[name='desc']").removeClass("isEnglish");
	        $("input[name='address']").removeClass("isEnglish");
	        $("input[name='type']").removeClass("isEnglish");
	        $("input[name='feature']").removeClass("isEnglish");
	        $("input[name='name']").addClass("stringCheckAll");
	     //   $("textarea[name='desc']").addClass("stringCheckAll");
	        $("input[name='address']").addClass("stringCheckAll");
	        $("input[name='type']").addClass("stringCheckAll");
	        $("input[name='feature']").addClass("stringCheckAll");
        }
    });
