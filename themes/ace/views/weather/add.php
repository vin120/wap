<?php
    $this->pageTitle = Yii::t('vcos','发布天气预告');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Weather/report_list")?>"><?php echo yii::t('vcos', '天气预告列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '发布天气预告')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="add" onkeydown="if(event.keyCode==13){return false;}">
                                ...
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_city">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="weather" name="weather">
                                            <?php foreach ($weather as $row){
                                            	if($row['iso'] == 'zh_cn'){
                                            ?>
                                            <option value="<?php echo $row['id'].'-'.$row['weather_name']?>"><?php echo $row['weather_name']?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_weather">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="time" id="time" data-rel="tooltip" title="<?php echo yii::t('vcos', '开始时间为当天00:00:00,结束时间为当天23:59:59')?>" data-placement="bottom"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="time_iso" id="times" data-rel="tooltip" title="<?php echo yii::t('vcos', '开始时间为当天00:00:00,结束时间为当天23:59:59')?>" data-placement="bottom"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="scale" name="scale">
                                            <?php foreach ($wind_scale as $row){
                                            	if($row['iso'] == 'zh_cn'){
                                            ?>
                                            <option value="<?php echo $row['wind_scale_name']?>"><?php echo $row['wind_scale_name'];?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_scale">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="direction" name="direction">
                                            <?php foreach ($wind_direction as $row){
                                            	if($row['iso']=='zh_cn'){
                                            ?>
                                            <option value="<?php echo $row['wind_direction_name']?>"><?php echo  $row['wind_direction_name']?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_direction">
                                ...
                                <div class="form-group un_iso">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="min_temp" type="text"  name="min_temp" placeholder="<?php echo yii::t('vcos', '单位:摄氏度')?>" maxlength='80'/>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_min_temp">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '最低温度').yii::t('vcos','(外语)')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="min_temps" type="text"  name="min_temp_iso" placeholder="<?php echo yii::t('vcos', '单位:摄氏度')?>" maxlength='80'/>
                                    </div>
                                </div>
                                <div class="form-group un_iso">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '最高温度')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="max_temp" type="text"  name="max_temp" placeholder="<?php echo yii::t('vcos', '单位:摄氏度')?>" maxlength='80'/>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_max_temp">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '最高温度').yii::t('vcos','(外语)')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="max_temps" type="text"  name="max_temp_iso" placeholder="<?php echo yii::t('vcos', '单位:摄氏度')?>" maxlength='80'/>
                                    </div>
                                </div>
