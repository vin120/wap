<?php
    $this->pageTitle = Yii::t('vcos','添加休闲服务分类');
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        ...
                                        <?php echo $form->error($lc_language,'lc_name'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <div class="bootstrap-colorpicker">
                                            ...
                                            <?php echo $form->error($lc,'bg_color'); ?> 
                                        </div>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <?php echo $form->error($lc_language,'lc_img_url'); ?> 
                                    </div>
                                </div>
