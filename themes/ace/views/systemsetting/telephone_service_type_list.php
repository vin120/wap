<?php
    $this->pageTitle = Yii::t('vcos','电话服务类型列表');
...
<?php 
    ...
    if(in_array('182', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('184', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('186', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="center">
                                                                <label>
                                                                    <input type="checkbox" name="ids[]" value="<?php echo $row['tel_id'];?>" class="ace isclick" />
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </td>
                                                            <td><?php echo ++$key;?></td>
                                                            <td><?php echo $row['tel_name'];?></td>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    ...
                                                                    $this->widget('ManipulateWidget',array(
                                                                        ...
                                                                        'MethodName'=>'telephone_service_type_edit',
                                                                        'id'=>$row['tel_id'],
                                                                        'canedit'=>$canedit,
                                                                        'candelete'=>$candelete,
                                                                    ));
                                                ...
                                                <div class="center">
                                                    <?php
                                                        ...
                                                        $this->widget('BotWidget',array(
                                                            'ControllerName'=>'Systemsetting',
                                                            'MethodName'=>'telephone_service_type_add',
                                                            'canadd'=>$canadd,
                                                        ));
                                                    ?>
                                                </div>
...
jQuery(function($) {
    ...
    $( ".delete" ).on('click', function(e) {
        var $a = $(this).attr("id");
        e.preventDefault();
        $.post('checktype',{pid:$a},function(data){
            if(data==1){
                $('#danger1').hide();
            ...
            buttons: [
                {
                    ...
                    "id" : "danger1",
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Systemsetting/telephone_service_type_list");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
