                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Systemsetting/location_category")?>"><?php echo yii::t('vcos', '安全定位分类列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="edit" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '安全定位分类名称')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '安全定位分类名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="16" value="<?php echo $category['location_category_name']; ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($category['state']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="url" type="text" name="url" placeholder="<?php echo yii::t('vcos', '跳转地址')?>" value="<?php echo $category['location_category_herf_url']; ?>" maxlength="80"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <div class="bootstrap-colorpicker">
                                            <input id="bgcolor" name="bgcolor" type="text" class="input-small" value="<?php echo $category['bg_color']; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '图片')?>：</label>
                                    <img src="<?php echo Yii::app()->params['imgurl'].$category['location_category_img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
...
jQuery(function($){
    $("#edit").validate({
        ...
        messages:{
            name:"<?php echo yii::t('vcos', '邮轮信息分类名称')?>",
