<?php
    $this->pageTitle = Yii::t('vcos','添加网络通信分类');
    $this->pageTag = 'net_category_list';
    
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'net_category_add';
    $menu_type = 'net_category';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Systemsetting/net_category")?>"><?php echo yii::t('vcos', '网络通信分类列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '添加网络通信分类')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '网络通信分类名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5">
                                        <div style="margin-bottom: 10px;"><?php echo yii::t('vcos', '小时')?>：<input id="hour" name="hour" type="text"  maxlength="20" placeholder="<?php echo yii::t('vcos', '小时')?>"  /></div>
                                        <div><?php echo yii::t('vcos', '分钟')?>：<input id="minute" name="minute" type="text"  maxlength="20" placeholder="<?php echo yii::t('vcos', '分钟')?>"  /></div>
                                    </div>
