                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Servicetime/servicetime_list")?>"><?php echo yii::t('vcos', '服务时间列表 ')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '部门名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="tel" type="text" name="tel" maxlength='15' placeholder="<?php echo yii::t('vcos', '电话')?>" />
                                        <?php echo $form->error($service,'service_tel'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="address" placeholder="<?php echo yii::t('vcos', '地址')?>" class="col-xs-10 col-sm-8 col-md-8" name="address" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="time" placeholder="<?php echo yii::t('vcos', '营业时间')?>" class="col-xs-10 col-sm-8 col-md-8" name="time" maxlength="80" />
