<?php
    $this->pageTitle = Yii::t('vcos','编辑wifi服务');
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'wifi_service_add';
    $menu_type = 'wifi_service_list';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Wifisetting/wifi_service_list")?>"><?php echo yii::t('vcos', 'wifi服务管理')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑wifi服务')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '名称')?>" value="<?php echo $wifi_item_language['wifi_name']?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="80" />
                                        <?php echo $form->error($wifi_item_language,'wifi_name'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_name">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name2" placeholder="<?php echo yii::t('vcos', '名称').yii::t('vcos','(外语)')?>" class="col-xs-10 col-sm-8 col-md-8" name="name_iso" maxlength="80" />
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="price" value="<?php echo $wifi_item['sale_price']/100?>" placeholder="<?php echo yii::t('vcos', '价格')?>" class="col-xs-10 col-sm-8 col-md-8" name="price" maxlength="10" />
                                        <?php echo $form->error($wifi_item,'sale_price'); ?> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($wifi_item['status']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
...
jQuery(function($){
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
	        ...
	        $.post("<?php echo Yii::app()->createUrl("Wifisetting/getiso")?>",{iso:$a,id:$b},function(data){
	            if(data != 0){
...
function checkWifiName(){
    flag = 1;
    $id = "<?php echo $wifi_item['wifi_id']?>";
    $service_name = $("input[name='name']").val();
	$url = "<?php echo Yii::app()->createUrl("Wifisetting/WifiNameGetAgain")?>";
	$.ajax({
		type:'post',
		data:'name='+$service_name+'&id='+$id,
		url:$url,
		async: false,
