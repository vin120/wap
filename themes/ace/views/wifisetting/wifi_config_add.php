<?php
    $this->pageTitle = Yii::t('vcos','添加WiFi配置模式');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Wifisetting/wifi_config_list")?>"><?php echo yii::t('vcos', 'wifi配置模式列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '添加WiFi配置模式')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="" id="add">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="describe" placeholder="<?php echo yii::t('vcos', '模式说明')?>" class="col-xs-10 col-sm-8 col-md-8" name="describe" maxlength="80"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '登录网址')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="loginurl" placeholder="<?php echo yii::t('vcos', '登录网址')?>" class="col-xs-10 col-sm-8 col-md-8" name="loginurl" maxlength="80"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="logouturl" type="text" name="logouturl" maxlength="80" placeholder="<?php echo yii::t('vcos', '主动登出网址')?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '改变时长')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="change" placeholder="<?php echo yii::t('vcos', '改变时长')?>" class="col-xs-10 col-sm-8 col-md-8" name="change" maxlength="80"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '被动登出网址')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="notice" placeholder="<?php echo yii::t('vcos', '被动登出网址')?>" class="col-xs-10 col-sm-8 col-md-8" name="notice" maxlength="80"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '政策')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="policy" class="col-xs-10 col-sm-8 col-md-8" name="policy" maxlength="80" placeholder="<?php echo yii::t('vcos', '政策')?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', 'SSID')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="ssid" type="text" name="ssid" maxlength="80" placeholder="<?php echo yii::t('vcos', 'SSID')?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', 'ACIP')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="acip" type="text" name="acip" maxlength="80" placeholder="<?php echo yii::t('vcos', 'ACIP')?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right" for="form-field-1"><?php echo yii::t('vcos', 'APMAC')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="apmac" type="text" maxlength="80" name="apmac" placeholder="<?php echo yii::t('vcos', 'APMAC')?>"/>
                                    </div>
                                </div>
