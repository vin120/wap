<?php
    $this->pageTitle = Yii::t('vcos','编辑客房介绍');
    $theme_url = Yii::app()->theme->baseUrl;
    
   // $menu_type = 'room_detail_add';
    $menu_type = 'room_detail';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Room/room_detail")?>"><?php echo yii::t('vcos', '客房介绍列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑客房介绍')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '客房类别')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="room">
                                            <?php foreach ($room as $row){ ?>
                                            <option value="<?php echo $row['room_id']?>" <?php if($detail['room_id']==$row['room_id']){echo 'selected';}?> ><?php echo $row['room_name'];?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo Yii::app()->params['imgurl'].$detail['room_img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-sm-9 col-md-9">
                                        <?php 
                                        $msg = $detail_language['room_describe'];
                                    ...
                                    <?php echo $form->error($detail_language,'room_describe'); ?> 
                                </div>
                                <div class="space-4"></div>
...
jQuery(function($){
    ...
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
            ...
            $.post("<?php echo Yii::app()->createUrl("room/getiso_detail")?>",{iso:$a,id:$b},function(data){
                if(data != 0){
                    var result = jQuery.parseJSON(data);
                    $(".iso textarea").html('');
                    var msg = result['room_describe'];
