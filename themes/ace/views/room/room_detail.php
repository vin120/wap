<?php
    $this->pageTitle = Yii::t('vcos','客房介绍');
...
<?php 
    ...
    if(in_array('34', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('35', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('36', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '客房类别')?></th>
                                                            <th><?php echo yii::t('vcos', '客房图片')?></th>
                                                            <th><?php echo yii::t('vcos', '图片简介')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="<?php echo Yii::app()->params['imgurl'].$row['room_img_url'];?>" width="50"/></td>
                                                            <td><?php echo Helper::truncate_utf8_string($count, 20);?></td>
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Room/room_detail");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
