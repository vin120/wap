<?php
    $this->pageTitle = Yii::t('vcos','新增客房类别');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '客房类别名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        ...
                                        <?php echo $form->error($room_language,'deck_point_describe'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($room_language,'img_url'); ?> 
                                </div>
                               <div class="space-4"></div> 
