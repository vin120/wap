<?php
    $this->pageTitle = Yii::t('vcos','编辑游客须知分类');
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'notice_to_visitors_category_add';
    $menu_type = 'notice_to_visitors_category';
?>
<?php 
    //navbar 挂件
    $disable = 1;
            ...
            <div class="main-content"> 
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            <?php echo yii::t('vcos', '游客须知管理')?>
                            <small style="cursor:pointer">
                                    <i class="icon-double-angle-right"></i>
                                    <a href="<?php echo Yii::app()->createUrl("Safe/notice_to_visitors_category")?>"><?php echo yii::t('vcos', '游客须知分类列表 ')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑游客人须知分类')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '分类名')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" value="<?php echo $notice_to_visitors_category_language['category_name'];?>" />
                                        <?php echo $form->error($notice_to_visitors_category_language,'category_name'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group hidden iso iso_title">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles2" placeholder="<?php echo yii::t('vcos', '分类名').yii::t('vcos','(外语)')?>" class="col-xs-10 col-sm-8 col-md-8" name="title_iso" maxlength="80" value="" />
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($notice_to_visitors_category['state']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
...
jQuery(function($){  
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
            ...
            $a = $(this).val();
            $b = '<?php echo $_GET['id']?>';
            $.post("<?php echo Yii::app()->createUrl("Safe/getiso_category")?>",{iso:$a,id:$b},function(data){
                if(data != 0){
                    var result = jQuery.parseJSON(data);
                    $(".iso input:text").val('');
                    $(".iso_title input:text").val(result['category_name']);
