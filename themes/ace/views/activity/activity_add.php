<?php
    $this->pageTitle = Yii::t('vcos','添加活动');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Activity/activity_list")?>"><?php echo yii::t('vcos', '活动列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '添加活动')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '活动名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="42" />
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($activity,'start_time'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($activity,'end_time'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '封面图片')?>：</label>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <input type="file" name="photo" id="photo"/>
                                        <font style="color: red; display: none"><?php echo yii::t('vcos', '请上传图片')?></font>
                                        <?php echo $form->error($activity,'activity_img'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" checked="checked" class="ace ace-switch ace-switch-5" name="show_head" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
