<?php
    $this->pageTitle = Yii::t('vcos','编辑商品图片');
    $theme_url = Yii::app()->theme->baseUrl;
    
    $menu_type = 'product_img_add';
?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group product_sel">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        ...
                                        <select style="width:35%;" id="form-field-select-1" name="product">
                                            ...
                                            <option value="<?php echo $row['product_id'];?>" <?php if($product_img['product_id']==$row['product_id']){echo "selected='selected'";}?>><?php echo $row['product_name']?></option>
                                            <?php }?>
                                        </select>
                                        <?php echo $form->error($product_img,'product_id'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="sort" placeholder="<?php echo yii::t('vcos', '排序')?>" class="col-xs-10 col-sm-8 col-md-8" name="sort" maxlength="10" value="<?php echo $product_img['sort_order'];?>" />
                                        <?php echo $form->error($product_img,'sort_order'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '图片')?>：</label>
                                    <img src="<?php echo Yii::app()->params['imgurl'].$product_img['img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
