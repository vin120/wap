<?php
    $this->pageTitle = Yii::t('vcos','待售商品列表');
    $theme_url = Yii::app()->theme->baseUrl;
    $menu_type = 'product_wait_list';
?>
<?php 
    //navbar 挂件
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
		                                        ...
		                                        <form method="get" action="<?php echo Yii::app()->createUrl('Product/product_wait_list')?>">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['sale_end_time'];?></td>
                                                ...
                                                <div class="center">
                                                	<button id="down_submit" class="btn btn-xs">批量上架</button>
                                                	<button id="del_submit" class="btn btn-xs">批量删除</button>
                                                    <?php
                                                        //底部操作挂件
...
<script type="text/javascript">
    jQuery(function($) {
		...
		$("#down_submit").click(function(){
			var ids = $("table>tbody input[type='checkbox']:checked");
