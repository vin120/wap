<?php
    $this->pageTitle = Yii::t('vcos','在售商品列表');
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
		                                        ...
		                                        <form method="get" action="<?php echo Yii::app()->createUrl('Product/product_list')?>">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['sale_start_time'];?></td>
