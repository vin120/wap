<?php
    $this->pageTitle = Yii::t('vcos','商品图文列表');
    $theme_url = Yii::app()->theme->baseUrl;
    $menu_type = 'product_graphic_list';
?>
<?php 
    //navbar 挂件
    $this->widget('navbarWidget');
    if(in_array('351', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('352', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('353', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <style>
		                                        ...
		                                        <form method="get" action="<?php echo Yii::app()->createUrl('Product/product_graphic_list')?>">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($product_graphic as $key=>$row) { ?>
                                                        <tr>
                                                            <td class="center">
                                                                <label>
                                                            ...
                                                            <td><?php echo Helper::truncate_utf8_string($row['graphic_desc'], 20);?></td>
                                                            <td><?php echo $row['sort_order'];?></td>
                                                            <td><img src="<?php echo Yii::app()->params['imgurl'].$row['img_url'];?>" width="50" height="50"></td>
                                                            <td>
                                                                <?php
                                                                    $this->widget('ManipulateWidget',array(
                                                                        'ControllerName'=>'Product',
                                                                        'MethodName'=>'product_graphic_edit',
                                                                        'id'=>$row['id'],
                                                                        'canedit'=>$canedit,
                                                                        'candelete'=>$candelete,
                                                                    ));
                                                ...
                                                <div class="center">
                                                    <?php
                                                        ...
                                                        $this->widget('BotWidget',array(
                                                            'ControllerName'=>'Product',
                                                            'MethodName'=>'product_graphic_add',
                                                            'canadd'=>$canadd,
                                                            'candelete'=>$candelete,
                                                        ));
                                                    ?>
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            location.href="<?php echo Yii::app()->createUrl("Product/product_graphic_list");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
                    ,
