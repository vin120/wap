<?php
    $this->pageTitle = Yii::t('vcos','添加商品详情');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <textarea id="describe_text" name="describe_text" placeholder="<?php echo yii::t('vcos', '商品文本详情')?>"></textarea>
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <textarea id="describe_photo" placeholder="<?php echo yii::t('vcos', '商品图文详情')?>" name="describe_photo"></textarea>                                    </div>
