                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="edit" >
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $detail['order_type']==1?"餐厅":"免税店";?></label>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php if($detail['order_type']==1){echo yii::t('vcos', '餐厅').' : ';}else{echo yii::t('vcos', '免税店').' : ';}?></label>
                                    <label class="col-xs-8 col-sm-8 col-md-8 "><?php echo $detail['store_name'];?></label>
                                </div>
                                <div class="form-group">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo yii::t('vcos', '购买数量')?></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        $price = $row['buy_num']*$row['goods_price'];
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-6 col-sm-6 col-md-6" name="state">
                                            <option value="0" <?php if($detail['order_status'] == '0'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单提交')?></option>
                                            <option value="1" <?php if($detail['order_status'] == '1'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单支付')?></option>
                                            <option value="2" <?php if($detail['order_status'] == '2'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单发货')?></option>
                                            <option value="3" <?php if($detail['order_status'] == '3'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单完成')?></option>
                                            <option value="4" <?php if($detail['order_status'] == '4'){echo 'selected';}?> ><?php echo yii::t('vcos', '交易取消')?></option>
                                            <option value="5" <?php if($detail['order_status'] == '5'){echo 'selected';}?> ><?php echo yii::t('vcos', '处理中')?></option>
                                            <option value="6" <?php if($detail['order_status'] == '6'){echo 'selected';}?> ><?php echo yii::t('vcos', '交易失败，暂无库存')?></option>
