                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                             <label style="margin-top:-8px;">选择类型:</label>
                                             <select name="order_type_sel" style="width:120px;position: relative;bottom:5px;">
                                            		<option <?php if($type==0){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Dutyfreegoods/goods_order_list",array('type'=>0))?>">全部</option>
                                            		<option <?php if($type==1){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Dutyfreegoods/goods_order_list",array('type'=>1))?>">餐厅</option>
                                            		<option <?php if($type==2){echo "selected='selected'";}?> value="<?php echo Yii::app()->createUrl("Dutyfreegoods/goods_order_list",array('type'=>2))?>">免税店</option>
                                            	</select>
                                                <form method="post" >
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '类型')?></th>
                                                            <th><?php echo yii::t('vcos', '餐厅/免税店')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['order_type']==1?"餐厅":"免税店";?></td>
                                                            <td><?php echo $row['store_name'];?></td>
                                                            <td><?php echo $row['cn_name']['cn_name'];?></td>
                                                            <td><?php echo sprintf('%.2f',$row['totale_price']/100);?></td>
                                                            ...
                                                            <td>
                                                                <select class="col-xs-12 col-sm-12 col-md-12 state" name="state" id="<?php echo $row['order_id']?>" title="<?php echo $row['order_status'];?>">
                                                                    <option value="0" <?php if($row['order_status'] == '0'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单提交')?></option>
                                                                    <option value="1" <?php if($row['order_status'] == '1'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单支付')?></option>
                                                                    <option value="2" <?php if($row['order_status'] == '2'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单发货')?></option>
                                                                    <option value="3" <?php if($row['order_status'] == '3'){echo 'selected';}?> ><?php echo yii::t('vcos', '订单完成')?></option>
                                                                    <option value="4" <?php if($row['order_status'] == '4'){echo 'selected';}?> ><?php echo yii::t('vcos', '交易取消')?></option>
                                                                    <option value="5" <?php if($row['order_status'] == '5'){echo 'selected';}?> ><?php echo yii::t('vcos', '处理中')?></option>
                                                                    <option value="6" <?php if($row['order_status'] == '6'){echo 'selected';}?> ><?php echo yii::t('vcos', '交易失败，暂无库存')?></option>
...
<script type="text/javascript">
jQuery(function($) {
	$("select[name='order_type_sel']").change(function(){
		var path = $(this).val();
