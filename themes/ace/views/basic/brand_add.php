<?php
    $this->pageTitle = Yii::t('vcos','添加品牌');
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '品牌名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="40" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="names" placeholder="<?php echo yii::t('vcos', '品牌英文名')?>" class="col-xs-10 col-sm-8 col-md-8" name="names" maxlength="40" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="country">
                                            ...
                                            <option value="<?php echo $row['country_id']?>"><?php echo $row['country_cn_name']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<textarea id="desc" style=" overflow:auto; width: 66.6666%;height: 60px;resize: none;" placeholder="<?php echo yii::t('vcos', '品牌描述')?>" name="desc" maxlength=80></textarea>
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', 'LOGO图片')?>：</label>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <input type="file" name="photo" id="photo"/>
                                        <font style="color: red; display: none"><?php echo yii::t('vcos', '请上传图片')?></font>
                                        <?php echo $form->error($brand,'brand_logo'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
...
jQuery(function($){
    ...
    $("#add").validate({
        rules: {
            ...
            sort:{required:true,isIntGtZero:true,digits:true},
    ...
    $('form').submit(function(){
        ...
        if($.trim(name)!='' && $.trim(name_iso)!=''){
		    ...
		    $.ajax({
		        ...
		        type:'get',
		        data:'name='+name+'&name_iso='+name_iso,
		        async:false,
		     	dataType:'json',
