                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '国家名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="40" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name_en" placeholder="<?php echo yii::t('vcos', '国家英文名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name_en" maxlength="100" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <?php echo $form->error($country,'country_logo'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
