<?php
    $this->pageTitle = Yii::t('vcos','编辑旅行日程');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Travelschedule/travelschedule_list")?>"><?php echo yii::t('vcos', '旅行日程列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑旅行日程')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '标题')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" value="<?php echo $schedule_language['ts_title'];?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<textarea id="desc" style=" overflow:auto; width: 66.6666%;height: 60px;resize: none;" placeholder="<?php echo yii::t('vcos', '描述')?>" name="desc" maxlength=80><?php echo $schedule_language['ts_desc'];?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($schedule['ts_state']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="address" class="col-xs-10 col-sm-8 col-md-8" name="address" maxlength="80" value="<?php echo $schedule_language['ts_address'];?>" placeholder="<?php echo yii::t('vcos', '活动地点')?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="time" class="col-xs-10 col-sm-8 col-md-8 date-picker" name="time" maxlength="100" value="<?php echo Helper::truncate_utf8_string($schedule['ts_time'], 5,false);?>" placeholder="<?php echo yii::t('vcos', '活动日期')?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="stime" name="stime" type="text" class="form-control col-xs-8 col-sm-8 col-md-8" maxlength="100" value="<?php echo $schedule['ts_start_time'];?>" placeholder="<?php echo yii::t('vcos', '活动开始时间')?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="etime" name="etime" type="text" class="form-control col-xs-6 col-sm-6 col-md-6" maxlength="100" value="<?php echo $schedule['ts_end_time'];?>" placeholder="<?php echo yii::t('vcos', '活动结束时间')?>"/>
                                        <span class="input-group-addon">
                                            <i class="icon-time bigger-110"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo Yii::app()->params['imgurl'].$schedule['ts_img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-sm-9 col-md-9">
                                    	<?php 
		                                $msg = $schedule_language['ts_content'];
...
jQuery(function($){
    ...
    $(".iso_choose").click(function(){
        ...
        if($check == 'no'){
	        ...
	        $.post("<?php echo Yii::app()->createUrl("travelschedule/getiso")?>",{iso:$a,id:$b},function(data){
	            if(data != 0){
	                var result = jQuery.parseJSON(data);
	                $(".iso input:text").val('');
	                $(".iso textarea").html('');
	                $(".iso_title input:text").val(result['ts_title']);
	                $(".iso_address input:text").val(result['ts_address']);
	                var msg = result['ts_content'];
	                var reg = $img_ueditor_old;
	                msg= msg.replace(reg,$ueditor_url);
	                $(".iso_content textarea").html(msg);
	                $(".iso_desc textarea").html(result['ts_desc']);
