                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="tel" type="text" name="tel" placeholder="<?php echo yii::t('vcos', '电话')?>" maxlength="15" value="<?php echo $restaurant['restaurant_tel'];?>"/>
