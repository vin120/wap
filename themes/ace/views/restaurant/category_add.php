<?php
    $this->pageTitle = Yii::t('vcos','添加美食分类');
    $this->pageTag = 'category_list';
    
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'category_add';
    $menu_type = 'category_list';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Restaurant/category_list")?>"><?php echo yii::t('vcos', '美食分类管理')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '添加美食分类')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="category" placeholder="<?php echo yii::t('vcos', '分类名')?>" class="col-xs-10 col-sm-8 col-md-8" name="category" maxlength="16" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8"  id="sequence" type="text" name="sequence" placeholder="<?php echo yii::t('vcos', '顺序')?>" maxlength="4"/>
...
jQuery(function($){
    ...
    $('form').submit(function(){
        ...
        $name_iso = $("input[name='category_iso']").val();
        $sort = $("input[name='sequence']").val();
        $restaurant  = $("select[name='restaurant']").val();
        if($sort!='' && $name!=''){
	        var msg = checkCategoryName($restaurant,$name,$name_iso);
	        if(msg == 0){
			    alert('分类名已存在!');
		       return false;
		    }
...
function checkCategoryName($restaurant,$name,$name_iso=''){
    flag = 1;
    
	$url = "<?php echo Yii::app()->createUrl("Restaurant/CheckCategoryName")?>";
	$.ajax({
		type:'get',
		data:'restaurant='+$restaurant+'&name='+$name+'&name_iso='+$name_iso,
		url:$url,
		async: false,
