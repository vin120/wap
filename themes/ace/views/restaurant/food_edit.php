                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Restaurant/food_list")?>"><?php echo yii::t('vcos', '美食管理')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="old_price"  placeholder="<?php echo yii::t('vcos', '原价')?>" class="col-xs-10 col-sm-8 col-md-8" name="old_price" maxlength="10" value="<?php echo $food['old_price']/100;?>" />
                                        <?php echo $form->error($food,'old_price'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
...
jQuery(function($){
    $("#edit").validate({
        rules: {
            ...
            main_title_iso:{isEnglish:true},
            food_title_iso:{isEnglish:true}
        },
        messages:{
            main_title:{
