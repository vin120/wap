<?php
    $this->pageTitle = Yii::t('vcos','添加餐厅新图片');
    $this->pageTag = 'restaurant_img_list';
    
    $theme_url = Yii::app()->theme->baseUrl;
    
    //$menu_type = 'restaurant_img_add';
    $menu_type = 'restaurant_img_list';
?>
<?php 
    //navbar 挂件
    $disable = 1;
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Restaurant/restaurant_img_list")?>"><?php echo yii::t('vcos', '餐厅图片管理')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '添加餐厅新图片')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                    	...
                                    	<?php $url = Yii::app()->createUrl('Uploader/ImgFileUpload',array('restaurant_images'));?>
