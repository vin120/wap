<?php
    $this->pageTitle = Yii::t('vcos','编辑管理员');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small style="cursor:pointer">
                                    ...
                                    <a href="<?php echo Yii::app()->createUrl("Auth/admin")?>"><?php echo yii::t('vcos', '管理员列表')?></a>
                            </small>
                            <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php echo yii::t('vcos', '编辑管理员')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="edit" autocomplete="off">
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '管理员昵称')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="real_name" class="col-xs-10 col-sm-8 col-md-8" name="real_name" maxlength="80" placeholder="<?php echo yii::t('vcos', '管理员昵称')?>" value="<?php echo $admin['admin_real_name']?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="margin-left: 10px;">
                                        <input id="id-button-borders" type="checkbox" <?php if($admin['admin_state']){echo 'checked="checked"';}?> class="ace ace-switch ace-switch-5" name="state" value="1" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="email" class="col-xs-10 col-sm-8 col-md-8" name="email" maxlength="80" placeholder="<?php echo yii::t('vcos', '管理员邮箱')?>" value="<?php echo $admin['admin_email']?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="role">
                                            ...
                                            <option value="<?php echo $row['role_id']?>" <?php if($admin['role_id']==$row['role_id']){echo 'selected';}?>><?php echo $row['role_name'];?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <a href="<?php echo Yii::app()->createUrl("Auth/resetpassword?id={$admin['admin_id']}");?>" class="reset btn btn-warning"><?php echo yii::t('vcos', '重设密码')?></a>
                            </form>
                        </div><!-- /.col-xs-12 -->
                    </div><!-- /.row -->
                </div><!-- /.page-content -->
