...
<div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                                    <?php if($canedit){?>
                                                                    <a href="#" id="<?php echo $row['admin_id'];?>" class="edit btn btn-xs btn-info" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                        <i class="icon-edit bigger-120"></i>
                                                                    </a>
                                                                    <?php } ?>
                                                                    <?php if($candelete){?>
                                                                    <a href="#" id="<?php echo $row['admin_id'];?>" class="btn btn-xs btn-warning delete"  title="<?php echo yii::t('vcos', '删除');?>">
                                                                ...
                                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                                    <div class="inline position-relative">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                            <?php if($canedit){?>
                                                                            <li>
                                                                                <a href="#" id="<?php echo $row['admin_id'];?>" class="edit tooltip-info" data-rel="tooltip" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                                    <span class="green">
                                                                                        <i class="icon-edit bigger-120"></i>
                                                                                    </span>
                                                                                </a>
                                                                            ...
                                                                            <?php if($candelete){?>
                                                                            <li>
                                                                                <a href="#" class="tooltip-info delete" id="<?php echo $row['admin_id'];?>" data-rel="tooltip" title="<?php echo yii::t('vcos', '删除');?>">
                                                                                    <span class="red">
                                                                                        <i class="icon-trash bigger-120"></i>
                                                                                    </span>
                                                                                </a>
                                                ...
                                                <div class="center">
                                                    <?php if($canadd){?>
                                                    <a href="<?php echo Yii::app()->createUrl('Auth/admin_add');?>" class="btn btn-xs">
                ...
                <form action="<?php echo Yii::app()->createUrl("Auth/admin_edit");?>" method="post">
