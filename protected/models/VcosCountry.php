 ...
 */
class VcosCountry extends PrCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('country_number, status', 'numerical', 'integerOnly'=>true),
			...
			array('country_id, country_cn_name, country_en_name, country_code, country_short_code, country_number, country_logo, status', 'safe', 'on'=>'search'),
		);
	}
