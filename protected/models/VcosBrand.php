...
class VcosBrand extends PrCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('country_id, brand_status, sort_order', 'numerical', 'integerOnly'=>true),
			array('brand_cn_name, brand_en_name, brand_logo', 'length', 'max'=>128),
			array('brand_desc', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('brand_id, brand_cn_name, brand_en_name, country_id, brand_logo, brand_desc, brand_status, sort_order', 'safe', 'on'=>'search'),
		);
	}
