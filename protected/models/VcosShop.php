...
class VcosShop extends PrCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cash_deposit, shop_status, cruise_id, is_delete', 'numerical', 'integerOnly'=>true),
			...
			array('shop_id, shop_code, shop_title, shop_logo, shop_img_url, shop_desc, legal_representative, company_name, shop_address, cash_deposit, main_products, created, business_license, shop_status, cruise_id, is_delete', 'safe', 'on'=>'search'),
		);
	}
