...
class VcosProduct extends PrCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('inventory_num, sale_price, standard_price, cruise_id, shop_id, brand_id, sale_num, comment_num, creator_type, creator_id, status, is_rubbish', 'numerical', 'integerOnly'=>true),
			...
			array('product_id, product_code, product_name, product_desc, product_img, inventory_num, sale_price, standard_price, category_code, cruise_id, shop_id, brand_id, sale_num, comment_num, sale_start_time, sale_end_time, creator_type, created, creator, creator_id, status, origin, is_rubbish', 'safe', 'on'=>'search'),
		);
	}
