 ...
 */
class VcosLifeservice extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ls_category, old_price, ls_price', 'length', 'max'=>10),
			array('ls_img_url, ls_tel', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ls_id, ls_category, old_price, ls_price, ls_img_url, ls_tel, ls_state', 'safe', 'on'=>'search'),
		);
	}
