 ...
 * @property string $navigation_style_type
...
class VcosNavigation extends PrCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('sort_order, status, activity_id, cruise_id, is_show, is_category, is_main', 'numerical', 'integerOnly'=>true),
			array('navigation_name', 'length', 'max'=>32),
			array('navigation_style_type', 'length', 'max'=>10),
	...
	public function search()
	{
		...
		$criteria->compare('navigation_style_type',$this->navigation_style_type,true);
