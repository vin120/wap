...
class VcosActivity extends PrCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('status, creator_id, is_show_category, cruise_id, is_show_head, is_nav', 'numerical', 'integerOnly'=>true),
			...
			array('activity_id, activity_name, activity_desc, activity_img, start_time, end_time, status, created, creator, creator_id, is_show_category, cruise_id, is_show_head, is_nav', 'safe', 'on'=>'search'),
		);
	}
